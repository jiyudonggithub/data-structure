...
//	static {
//
//		conf.set("hbase.zookeeper.quorum", "192.168.232.130");
//
//		// 注意这里静态块IP的配置
//
...
//
//			NamespaceDescriptor weibo = NamespaceDescriptor.create("weibo").addConfiguration("creator", "test")
//
...
//	/**
//	 *
//	 * 创建微博内容表 Table Name:weibo:content RowKey:用户ID_时间戳 ColumnFamily:info
//	 *
//	 * ColumnLabel:标题 内容 图片URL Version:1个版本
//	 *
//	 */
//
...
//	/**
//	 *
//	 * 用户关系表 Table Name:weibo:relations RowKey:用户ID ColumnFamily:attends,fans
//	 *
//	 * ColumnLabel:关注用户ID，粉丝用户ID ColumnValue:用户ID Version：1个版本
//	 *
//	 */
//
...
//	/**
//	 *
//	 * 创建微博收件箱表 Table Name: weibo:receive_content_email RowKey:用户ID
//	 *
//	 * ColumnFamily:info ColumnLabel:用户ID-发布微博的人的用户ID ColumnValue:关注的人的微博的RowKey
//	 *
//	 * Version:1000
//	 *
//	 */
...
//
//					TableName.valueOf(TABLE_RECEIVE_CONTENT_EMAIL));
//
//			HColumnDescriptor info = new HColumnDescriptor(Bytes.toBytes("info"));
//
//			info.setBlockCacheEnabled(true);
...
//	/**
//	 *
//	 * 关注用户逻辑 a、在微博用户关系表中，对当前主动操作的用户添加新的关注的好友 b、在微博用户关系表中，对被关注的用户添加粉丝（当前操作的用户）
//	 *
...
//	/**
//	 *
//	 * 取消关注（remove) a、在微博用户关系表中，对当前主动操作的用户删除对应取关的好友
...
//	/**
//	 *
//	 * 获取微博实际内容 a、从微博收件箱中获取所有关注的人的发布的微博的rowkey b、根据得到的rowkey去微博内容表中得到数据
//	 *
...
//
//		wb.publishContent("0001", "阿里巴巴");
//
//		wb.publishContent("0001", "阿里妈妈");
//
//	}
//
//	// 添加关注
...
//
//		wb.publishContent("0002", "0002发的微博");
//
//		wb.publishContent("0003", "0003发的微博");
//
